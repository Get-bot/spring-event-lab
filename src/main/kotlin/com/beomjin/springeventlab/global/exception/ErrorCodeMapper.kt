...
import com.beomjin.springeventlab.global.exception.ErrorCode.EVENT_SOLD_OUT
...
import com.beomjin.springeventlab.global.exception.ErrorCode.REDIS_UNAVAILABLE
...
object ErrorCodeMapper {
    fun ErrorCode.httpStatus(): HttpStatus =
        when (this) {
            ...
            EVENT_SOLD_OUT -> HttpStatus.GONE
